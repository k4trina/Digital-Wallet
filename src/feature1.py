...
#
# This program implements Feature 1 of the coding challenge by
# verifying users up to 1 degree away in the friends network
#
...
# Stream payments, and verify users up to 1 degree away in friends network
max_degree_separation = 1
