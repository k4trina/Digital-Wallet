...
#
# This program implements Feature 2 of the coding challenge by
# verifying users up to 2 degrees away in the friends network
#
...
# Stream payments, and verify users up to 2 degrees away in friends network
max_degree_separation = 2
